...
e.style.backgroundColor='#FFFFFF';i++;}}function sgwAdmin(mod){var a=document.getElementById('AdminFlag');var u=document.getElementById('UserID');var p=document.getElementById('UserPW');if(mod==1)a.checked=true;else if(mod==0)a.checked=false;if(a.checked){u.value=null;u.disabled=true;u.style.backgroundColor='#EBEBE4';p.value=null;p.focus();}else{u.disabled=false;u.style.backgroundColor='#FFFFFF';u.focus();}}